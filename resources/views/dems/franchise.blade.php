    ...
    <div class="container-fluid">
        ...
        <div class="row mega-2 d-flex align-items-center justify-content-between pt-3 pt-lg-5">
            <div class="col-lg-6 col-md-11 col-11 mega-2-area p-2 mt-3">
                <h6 class="pb-2 ms-4">GET YOUR FRANCHISE TO THE TOP OF GOOGLE.<h6>
                        <h3 class="pb-2 ms-4 pe-5">Our experts go in-depth to bring you there.</h3>
                        <p class="pb-4 ms-4 pe-5">The secret to SEO success lies in both on-page and off-page strategies. Our SEO team performs a deep analysis of your franchise's existing website and its presence online to improve the site’s content and structure. Off-page efforts are made in local directories and relevant franchise industry resources to build incoming links from reputable web sources. The result of this combined approach eclipses franchise advertisement channels and paid acquisition strategies.</p>
        ...
        <div class="row mega-1">
            <div class="col-lg-7 col-11 mega-1-area p-2">
                <h1 class="pb-2 ms-4">IMPACTFUL KEYWORDS</h1>
                <h3 class="pb-2 ms-4">OPTIMUM STRATEGY</h3>
                <p class="pb-4 ms-4">You can have the most powerful SEO strategy in the world, but it doesn't mean anything if you don't use the right keywords. We perform arduous research on each of your markets and target audiences to understand how they search online to produce the right keywords for your franchise SEO campaign.</p>
                <div class="ms-4">
                    <a href="">
                        REQUEST A QUOTE ➔
                    </a>
